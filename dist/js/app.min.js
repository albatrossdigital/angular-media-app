...
!function() {
    ...
    $scope.filters = {
        ...
        console.log("FILEZZ", $rootScope.files), $state.go("base");
        ...
        controller: function($scope, $rootScope, $state, Flickr, CoreFile) {
            $scope.filters = {
                ...
                $scope.queue = {
                    ...
                    console.log("FILES PRE", item), file.$save(function(data) {
                        ...
                        console.log("FILES POST", $scope.queue.files), $scope.queue = void 0, $state.go("base"));
                    });
    ...
    $scope.init = function(params) {
        ...
        console.log($rootScope), console.log(params);
    };
