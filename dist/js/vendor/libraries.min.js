...
!function(root, factory) {
    ...
    function toPrimitive(input) {
        ...
        if (valueOf = input.valueOf, isFunction(valueOf) && (val = valueOf.call(input), 
        isPrimitive(val))) return val;
        if (toStr = input.toString, isFunction(toStr) && (val = toStr.call(input), isPrimitive(val))) return val;
        throw new TypeError();
    }
    var defineProperty, ArrayPrototype = Array.prototype, ObjectPrototype = Object.prototype, FunctionPrototype = Function.prototype, StringPrototype = String.prototype, NumberPrototype = Number.prototype, array_slice = ArrayPrototype.slice, array_splice = ArrayPrototype.splice, array_push = ArrayPrototype.push, array_unshift = ArrayPrototype.unshift, call = FunctionPrototype.call, to_string = ObjectPrototype.toString, isFunction = function(val) {
        return "[object Function]" === to_string.call(val);
    }, isRegex = function(val) {
        return "[object RegExp]" === to_string.call(val);
    }, isArray = function(obj) {
        return "[object Array]" === to_string.call(obj);
    }, isString = function(obj) {
        return "[object String]" === to_string.call(obj);
    }, isArguments = function(value) {
        var str = to_string.call(value), isArgs = "[object Arguments]" === str;
        return isArgs || (isArgs = !isArray(value) && null !== value && "object" == typeof value && "number" == typeof value.length && value.length >= 0 && isFunction(value.callee)), 
        isArgs;
    ...
    defineProperties(FunctionPrototype, {
        bind: function(that) {
            ...
            }, boundLength = Math.max(0, target.length - args.length), boundArgs = [], i = 0; boundLength > i; i++) boundArgs.push("$" + i);
    ...
    var owns = call.bind(ObjectPrototype.hasOwnProperty), spliceNoopReturnsEmptyArray = function() {
    ...
    defineProperties(ArrayPrototype, {
        splice: function(start, deleteCount) {
            ...
            var args = arguments;
            return this.length = Math.max(toInteger(this.length), 0), arguments.length > 0 && "number" != typeof deleteCount && (args = array_slice.call(arguments), 
            args.length < 2 ? args.push(this.length - start) : args[1] = toInteger(deleteCount)), 
            array_splice.apply(this, args);
        }
    }, !spliceWorksWithEmptyObject);
    var hasUnshiftReturnValueBug = 1 !== [].unshift(0);
    defineProperties(ArrayPrototype, {
        unshift: function() {
    ...
    defineProperties(ArrayPrototype, {
        ...
        map: function(fun) {
            ...
            if (!isFunction(fun)) throw new TypeError(fun + " is not a function");
        ...
        filter: function(fun) {
            var value, object = ES.ToObject(this), self = splitString && isString(this) ? this.split("") : object, length = self.length >>> 0, result = [], thisp = arguments[1];
            if (!isFunction(fun)) throw new TypeError(fun + " is not a function");
    ...
    ArrayPrototype.reduceRight && (reduceRightCoercesToObject = "object" == typeof ArrayPrototype.reduceRight.call("es5", function(_, __, ___, list) {
        ...
        reduceRight: function(fun) {
            ...
            do i in self && (result = fun.call(void 0, result, self[i], i, object)); while (i--);
            return result;
        }
    ...
    var hasFirefox2LastIndexOfBug = Array.prototype.lastIndexOf && -1 !== [ 0, 1 ].lastIndexOf(0, -3);
    defineProperties(ArrayPrototype, {
    ...
    var hasDontEnumBug = !{
        toString: null
    }.propertyIsEnumerable("toString"), hasProtoEnumBug = function() {}.propertyIsEnumerable("prototype"), dontEnums = [ "toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor" ], dontEnumsLength = dontEnums.length;
    defineProperties(Object, {
        keys: function(object) {
            var isFn = isFunction(object), isArgs = isArguments(object), isObject = null !== object && "object" == typeof object, isStr = isObject && isString(object);
            if (!isObject && !isFn && !isArgs) throw new TypeError("Object.keys called on a non-object");
            var theKeys = [], skipProto = hasProtoEnumBug && isFn;
            if (isStr || isArgs) for (var i = 0; i < object.length; ++i) theKeys.push(String(i)); else for (var name in object) skipProto && "prototype" === name || !owns(object, name) || theKeys.push(String(name));
            if (hasDontEnumBug) for (var ctor = object.constructor, skipConstructor = ctor && ctor.prototype === object, j = 0; dontEnumsLength > j; j++) {
                var dontEnum = dontEnums[j];
                skipConstructor && "constructor" === dontEnum || !owns(object, dontEnum) || theKeys.push(dontEnum);
            }
            return theKeys;
        }
    });
    ...
    }(1, 2), originalKeys = Object.keys;
    defineProperties(Object, {
        keys: function(object) {
            return originalKeys(isArguments(object) ? ArrayPrototype.slice.call(object) : object);
        }
    }, !keysWorksWithArguments);
    var negativeDate = -621987552e5, negativeYearString = "-000001", hasNegativeDateBug = Date.prototype.toISOString && -1 === new Date(negativeDate).toISOString().indexOf(negativeYearString);
    ...
    var supportsExtendedYears = 1e15 === Date.parse("+033658-09-27T01:46:40.000Z"), acceptsInvalidDates = !isNaN(Date.parse("2012-04-04T24:00:00.500Z")) || !isNaN(Date.parse("2012-11-31T23:59:59.000Z")), doesNotParseY2KNewYear = isNaN(Date.parse("2000-01-01T00:00:00.000Z"));
    (!Date.parse || doesNotParseY2KNewYear || acceptsInvalidDates || !supportsExtendedYears) && (Date = function(NativeDate) {
        ...
        Date.prototype.constructor = Date, Date.parse = function(string) {
            ...
            if (match) {
                ...
                isLocalTime && (result = toUTC(result)), result >= -864e13 && 864e13 >= result) ? result : 0/0;
            }
    ...
    var hasToFixedBugs = NumberPrototype.toFixed && ("0.000" !== 8e-5.toFixed(3) || "1" !== .9.toFixed(0) || "1.25" !== 1.255.toFixed(2) || "1000000000000000128" !== 0xde0b6b3a7640080.toFixed(0)), toFixedHelpers = {
        ...
        multiply: function(n, c) {
            for (var i = -1; ++i < toFixedHelpers.size; ) c += n * toFixedHelpers.data[i], toFixedHelpers.data[i] = c % toFixedHelpers.base, 
    ...
    defineProperties(NumberPrototype, {
        toFixed: function(fractionDigits) {
            ...
            } else toFixedHelpers.multiply(0, z), toFixedHelpers.multiply(1 << -e, 0), m = toFixedHelpers.numToString() + "0.00000000000000000000".slice(2, 2 + f);
    ...
    2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || ".".split(/()()/).length > 1 ? !function() {
        ...
        StringPrototype.split = function(separator, limit) {
            ...
            if ("[object RegExp]" !== to_string.call(separator)) return string_split.call(this, separator, limit);
            ...
            for (separator = new RegExp(separator.source, flags + "g"), string += "", compliantExecNpcg || (separator2 = new RegExp("^" + separator.source + "$(?!\\s)", flags)), 
            limit = "undefined" == typeof limit ? -1 >>> 0 : ES.ToUint32(limit); (match = separator.exec(string)) && (lastIndex = match.index + match[0].length, 
            ...
            }), match.length > 1 && match.index < string.length && array_push.apply(output, match.slice(1)), 
        ...
        return "undefined" == typeof separator && 0 === limit ? [] : string_split.call(this, separator, limit);
    });
    ...
    replaceReportsGroupsCorrectly || (StringPrototype.replace = function(searchValue, replaceValue) {
        var isFn = isFunction(replaceValue), hasCapturingGroups = isRegex(searchValue) && /\)[*?]/.test(searchValue.source);
        if (isFn && hasCapturingGroups) {
            var wrappedReplaceValue = function(match) {
                var length = arguments.length, originalLastIndex = searchValue.lastIndex;
                searchValue.lastIndex = 0;
                var args = searchValue.exec(match) || [];
                return searchValue.lastIndex = originalLastIndex, args.push(arguments[length - 2], arguments[length - 1]), 
    ...
    defineProperties(StringPrototype, {
        ...
        return function(str, radix) {
            return str = String(str).trim(), Number(radix) || (radix = hexRegex.test(str) ? 16 : 10), 
            origParseInt(str, radix);
        };
    }(parseInt));
}), /**
...
function(window, document, undefined) {
    ...
    function limitToFilter() {
        return function(input, limit) {
            ...
            var i, n;
            if (limit > input.length ? limit = input.length : limit < -input.length && (limit = -input.length), 
            limit > 0) i = 0, n = limit; else {
                if (!limit) return [];
    ...
    bindonceModule.directive("bindonce", function() {
        ...
        var bindonceDirective = {
                ...
                var showHideBinder = function(elm, attr, value) {
                    ...
                    setupWatcher: function(bindonceValue) {
                        ...
                        this.watcherRemover = $scope.$watch(bindonceValue, function(newValue) {
                            void 0 !== newValue && (that.removeWatcher(), that.runBinders());
                        }, !0);
                    },
                    ...
                    runBinders: function() {
                        for (;this.binders.length > 0; ) {
                            ...
                            if (!this.group || this.group == binder.group) {
                                ...
                                switch (binder.attr) {
                                  case "boIf":
                                    toBoolean(value) && binder.transclude(binder.scope.$new(), function(clone) {
                                        var parent = binder.element.parent(), afterNode = binder.element && binder.element[binder.element.length - 1], parentNode = parent && parent[0] || afterNode && afterNode.parentNode, afterNextSibling = afterNode && afterNode.nextSibling || null;
                                  ...
                                  case "boSwitch":
                                    ...
                                    angular.forEach(selectedTranscludes, function(selectedTransclude) {
                                        selectedTransclude.transclude(binder.scope.$new(), function(clone) {
                                            var parent = selectedTransclude.element.parent(), afterNode = selectedTransclude.element && selectedTransclude.element[selectedTransclude.element.length - 1], parentNode = parent && parent[0] || afterNode && afterNode.parentNode, afterNextSibling = afterNode && afterNode.nextSibling || null;
                                            angular.forEach(clone, function(node) {
                                                parentNode.insertBefore(node, afterNextSibling);
                                            });
                                        });
            ...
            link: function(scope, elm, attrs, bindonceController) {
                var value = attrs.bindonce ? scope.$eval(attrs.bindonce) : !0;
                void 0 !== value ? value.then && "function" == typeof value.then ? value.then(function() {
                    bindonceController.runBinders();
                }) : bindonceController.runBinders() : (bindonceController.setupWatcher(attrs.bindonce), 
...
function(window, angular, undefined) {
    ...
    UrlMatcher.prototype.concat = function(pattern, config) {
        ...
        search = !0);
        return result;
    }, UrlMatcher.prototype.$types = {}, Type.prototype.is = function() {
        return !0;
...
+function($) {
    ...
    Affix.VERSION = "3.3.1", Affix.RESET = "affix affix-top affix-bottom", Affix.DEFAULTS = {
        offset: 0,
        target: window
        ...
        return null != offsetTop && offsetTop >= colliderTop ? "top" : null != offsetBottom && colliderTop + colliderHeight >= scrollHeight - offsetBottom ? "bottom" : !1;
...
}(jQuery), function(angular, factory) {
    ...
    return module.value("fileUploaderOptions", {
        ...
        }, FileUploader.prototype.onAfterAddingAll = function() {}, FileUploader.prototype.onAfterAddingFile = function() {}, 
        FileUploader.prototype.onWhenAddingFileFailed = function() {}, FileUploader.prototype.onBeforeUploadItem = function() {}, 
        FileUploader.prototype.onProgressItem = function() {}, FileUploader.prototype.onProgressAll = function() {}, 
        FileUploader.prototype.onSuccessItem = function() {}, FileUploader.prototype.onErrorItem = function() {}, 
        FileUploader.prototype.onCancelItem = function() {}, FileUploader.prototype.onCompleteItem = function() {}, 
        ...
        }, FileItem.prototype.onBeforeUpload = function() {}, FileItem.prototype.onProgress = function() {}, 
        FileItem.prototype.onSuccess = function() {}, FileItem.prototype.onError = function() {}, 
        FileItem.prototype.onCancel = function() {}, FileItem.prototype.onComplete = function() {}, 
