...
!function(window, document, undefined) {
    ...
    function minErr(module, ErrorConstructor) {
        return ErrorConstructor = ErrorConstructor || Error, function() {
            ...
            }), message = message + "\nhttp://errors.angularjs.org/1.3.12/" + (module ? module + "/" : "") + code, 
...
angular.module("xeditable", []).value("editableOptions", {
    ...
    function EditableController($scope, $attrs, $element, $parse, editableThemes, editableOptions, $rootScope, $compile, $q) {
        ...
        self.single = null, self.buttons = "right", self.init = function(single) {
            ...
            valueGetter = $parse($attrs[self.directiveName]), self.buttons = self.single ? self.attrs.buttons || editableOptions.buttons : "no", 
